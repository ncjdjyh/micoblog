...
CREATE TABLE `fans`  (
  ...
  `follower` int(11) NULL DEFAULT NULL COMMENT '粉丝',
  `status` int(2) NULL DEFAULT 1,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_mysql500_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fans
-- ----------------------------
INSERT INTO `fans` VALUES (1, 1, 43, 1, '2019-08-29 22:14:34', '2019-08-15 22:14:37');
INSERT INTO `fans` VALUES (2, 1, 44, 1, '2019-08-05 22:14:47', '2019-08-05 22:14:51');
...
CREATE TABLE `follow`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NULL DEFAULT NULL COMMENT '用户',
  `followed_user` int(11) NULL DEFAULT NULL COMMENT '关注人id',
  `status` int(2) NULL DEFAULT 1 COMMENT '1关注 0取消关注',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_mysql500_ci ROW_FORMAT = Dynamic;
...
-- Records of follow
-- ----------------------------
INSERT INTO `follow` VALUES (1, 1, 41, 1, '2019-08-29 22:13:33', '2019-08-29 22:13:36');
INSERT INTO `follow` VALUES (2, 1, 42, 1, '2019-08-28 22:13:52', '2019-08-28 22:14:01');
