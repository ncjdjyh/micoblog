                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-4 col-xs-4" align="center">
                            <a href="user.html?userId=${theUser.userid}&page=0">我的博客</a>
                        </div>
                        <div class="col-md-4 col-xs-4" align="center">
                            <a href="user.html?userId=${theUser.userid}&page=1">关注者</a>
                        </div>
                        <div class="col-md-4 col-xs-4" align="center">
                            <a href="user.html?userId=${theUser.userid}&page=2">关注的人</a>
                        </div>
                    </div>
                </div>
            </div>
